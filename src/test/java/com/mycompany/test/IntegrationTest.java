...
import com.mycompany.test.TestApp;
import com.mycompany.test.config.AsyncSyncConfiguration;
import com.mycompany.test.config.EmbeddedSQL;
...
@SpringBootTest(classes = { TestApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
